...
def initiateEcho(peer, neighbours, sequenceNumber, operation, sensor_val=0, kill=False):
    payload = 0
        ...
        while not kill:
            ...
            if command in operation_list:
                ...
                if opcode == 3 or opcode == 4:
                    ...
                    sequenceNumber, kill  = initiateEcho(peer, neighbours, sequenceNumber, opcode, sensor.val)
                    time.sleep(0.1)
                    timeCounter += 1
                command = ""
